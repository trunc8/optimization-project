...
def benchmarkBasinHoppingAlgorithm():
  ...
  for t in range(T):
    ...
    class MyBounds(object):
      def __init__(self, xmax=ub, xmin=lb ):
    ...
    #result = basinhopping(evalObjective1, np.ones(12),niter=12, minimizer_kwargs=minimizer_kwargs,accept_test=mybounds)
    ...
    result =dual_annealing(evalObjective2, bounds=list(zip(lb, ub)), seed=1234)
...
if __name__ == '__main__':
  ...
  random.seed(0)
  benchmarkBasinHoppingAlgorithm()
